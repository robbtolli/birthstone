...
enum Symbol
{
	S_NONE = 0, S_FAIL, S_END, S_ID, S_NUM,  S_STR, S_BOOL, S_LIST, S_FUNC,
	...
	S_IF, S_ELIF, S_ELSE, S_WRITE, S_PRINT, S_DEF, S_CLASS, S_RET,
	S_DO, S_WHILE, S_UNTIL, S_FOR, S_IN, S_BREAK, S_CONT, S_READ, S_DEL,
